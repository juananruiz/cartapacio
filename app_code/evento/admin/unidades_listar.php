...
//---------------------------------------------------------------------------------------------
$_nombre_pagina = "Listar unidades";
...
if ($permiso->tiene_permiso($condicion))
{
	...
	$unidades = $unidad->unidades_recursos("1");
	...
	$plantilla = "evento/admin/unidades_listar.tpl";
}
else
{
	$mensaje = "No tiene permisos para listar unidades";
  $mensaje_tipo = "Error";
